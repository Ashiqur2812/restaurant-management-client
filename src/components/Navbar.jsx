        ...
        <div className='mb-20 '>
            <div className="navbar fixed w-full top-0 z-50 backdrop-blur-xl px-6">
                ...
                <div className="navbar-end flex items-center gap-4">
                    {
                        user && user?.email ? <>
                            <img referrerPolicy='no-referrer' className="h-10 w-10 rounded-full" src={user?.photoURL} alt="User" />
                            ...
                            >
                                ...
                                ></span>
                                <span class="relative text-base font-semibold">Log Out</span>
                            </button>
                        </>
                            : <>
                                <Link to='/login'>
                                    ...
                                    >
                                        <span
                                            class="absolute w-0 h-0 transition-all duration-500 ease-out bg-emerald-600 rounded-full group-hover:w-56 group-hover:h-56"
                                        ></span>
                                        <span class="absolute bottom-0 left-0 h-full -ml-2">
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"

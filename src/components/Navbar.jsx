...
const Navbar = () => {
    ...
    const links = <>
        ...
        <li><NavLink to='/all-foods' className="nav-link hover:scale-110 transition-transform duration-300">All Foods</NavLink></li>
        <li><NavLink to='/gallery' className="nav-link hover:scale-110 transition-transform duration-300">Gallery</NavLink></li>
        <li><NavLink to='/my-foods' className="nav-link hover:scale-110 transition-transform duration-300">My Foods</NavLink></li>
        <li><NavLink to='/add-food' className="nav-link hover:scale-110 transition-transform duration-300">Add Food</NavLink></li>
        <li><NavLink to='/my-orders' className="nav-link hover:scale-110 transition-transform duration-300">My Orders</NavLink></li>
    </>;
            ...
            <div className="navbar fixed w-full top-0 z-50 backdrop-blur-lg md:px-8 py-8 md:py-5">
                <div className="navbar-start">
                    ...
                    <div className='flex items-center'>
                        <div>
                            <img className='w-10 md:w-16 h-10 md:h-16 object-cover rounded-xl hover:rotate-360 transition-transform duration-1000' src={logo} alt="Logo" />
                        </div>
                        <div>
                            <Link to='/' className="btn btn-ghost text-2xl md:text-3xl hover:text-rose-500 ">Food Kingdom</Link>
                        </div>
                    </div>
                </div>
